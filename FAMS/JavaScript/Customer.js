...
function AddAddress() {
    ...
    var markup = "<div class=' col-md-12 col-sm-12 col-xs-12 addaddress mb-2' ><div class='row'><div class='col-md-12 col-xs-12 col-sm-12 ' style='border-bottom: 1px solid #c5c5c5;'><label style='width: 98%; font-size: 14px;'>Address " + AddressCounter + "</label><label id='btnCross_" + AddressCounter+"'>X</label></div></div><div class='row' style=' margin-top: 13px;'><div class='col-md-4 col-sm-4 col-xs-4'> <div class='form-group'><label class='col-md-12 col-sm-4 col-xs-4 p-0'>Address Line 1:</label> <input type='text'  id ='txtAddressLine1_" + AddressCounter + "'class='col-md-12 col-sm-7 col-xs-7' /> </div></div><div class='col-md-4 col-sm-4 col-xs-4'><div class='form-group'> <label class='col-md-12 col-sm-4 col-xs-4 p-0'>Address Line 2:</label> <input type='text' class='col-md-12 col-sm-12 col-xs-7' id='txtAddressLine2_" + AddressCounter + "' /> </div ></div > <div class='col-md-4 col-sm-4 col-xs-4'> <div class='form-group'>  <label class='col-md-12 col-sm-4 col-xs-4 p-0'>PinCode:</label><input type='text' id='txtPincode_" + AddressCounter + "' class='col-md-12 col-sm-7 col-xs-7' /></div ></div > </div > <div class='row' ><div class='col-md-4 col-sm-4 col-xs-4'> <div class='form-group'> <label class='col-md-12 col-sm-4 col-xs-4 p-0'>State :</label><div class='col-md-12 col-sm-7 col-xs-7 p-0'> <input type='text' id='ddlstate_" + AddressCounter + "' class=' col-md-12 col-sm-12 col-xs-12 p-0' /> </div></div ></div > <div class='col-md-4 col-sm-4 col-xs-4'> <div class='form-group'><label class='col-md-12 col-sm-4 col-xs-4 p-0'>City :</label><div class='col-md-12 col-sm-7 col-xs-7 p-0'><input type='text' id='ddlcity_" + AddressCounter + "' class=' col-md-12 col-sm-12 col-xs-12 p-0' /></div></div></div></div></div>";
