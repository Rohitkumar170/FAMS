...
namespace FAMS.Entity
{
    ...
    public partial class FAMSEntities : DbContext
    {
        ...
        public virtual DbSet<tblBankCustomer> tblBankCustomers { get; set; }
        public virtual DbSet<tblCustomer> tblCustomers { get; set; }
        public virtual DbSet<tblEntity> tblEntities { get; set; }
        public virtual DbSet<tblMstCustomerType> tblMstCustomerTypes { get; set; }
        public virtual DbSet<tblTrialbalanceTra> tblTrialbalanceTras { get; set; }
        public virtual DbSet<tblTBTransaction> tblTBTransactions { get; set; }
        public virtual DbSet<tblCashTransaction> tblCashTransactions { get; set; }
        public virtual DbSet<tblHoldingTran> tblHoldingTrans { get; set; }
        ...
        {
            var bankcustomeridParameter = bankcustomerid.HasValue ?
                new ObjectParameter("Bankcustomerid", bankcustomerid) :
                new ObjectParameter("Bankcustomerid", typeof(long));
    
            var transdatatypeParameter = transdatatype.HasValue ?
                new ObjectParameter("Transdatatype", transdatatype) :
                new ObjectParameter("Transdatatype", typeof(int));
    
            var custAccountnoParameter = custAccountno != null ?
                new ObjectParameter("CustAccountno", custAccountno) :
                new ObjectParameter("CustAccountno", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("INSERTTRANSHEADER", bankcustomeridParameter, transdatatypeParameter, custAccountnoParameter);
        }
    
        public virtual int INSERTHEADLINE(string accountId, string accountSubId, string accountSubcat, string openingbalDR, string openingbalCR, string transDuringperiodDR, string transDuringperiodCR, string closingbalDR, string closingbalCR)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("INSERTHEADLINE", accountIdParameter, accountSubIdParameter, accountSubcatParameter, openingbalDRParameter, openingbalCRParameter, transDuringperiodDRParameter, transDuringperiodCRParameter, closingbalDRParameter, closingbalCRParameter);
        }
