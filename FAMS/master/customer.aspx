                    ...
                    <table class="bankmasterTable" id="gridtable">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 60px">Account Number
                                </th>
                        ...
                        <tr>
                            ...
                            <td style="width: 60px">Yoeki Softech Pvt.ltd
                            </td>
                            <td style="width: 60px">Under Progress
                            </td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-sm-4 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-md-4 col-sm-4 col-xs-4 p-0">Customer Code:</label>
                                                    <input type="text" class="col-md-7 col-xs-7 col-sm-7" id="txtcustcode" onkeypress="RemoveValidation()" />
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-md-4 col-sm-4 col-xs-4 p-0">Customer Name:</label>
                                                    <input type="text" id="txtcustname" onkeypress="RemoveValidation()" class="col-md-7 col-xs-7 col-sm-7" />
...
<label class="col-md-4 col-sm-4 col-xs-4">Customer Type:</label>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-md-4 col-sm-4 col-xs-4 p-0">Description:</label>

                                                    <input type="text" id="txtdesc" onkeypress="RemoveValidation()" class="col-md-7 col-xs-7 col-sm-7" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-md-4 col-sm-4 col-xs-4 p-0">Customer Representative:</label>
                                                    ...
                                                    <%--<input type="text" id="ddlcustRep" class=" col-md-7 col-sm-7 col-xs-7 p-0 kendobox"/>--%>
                                                </div>
                                            </div>
                                         ...
                                         <div class="col-md-12 col-sm-12 col-xs-12"><button type="button" id="btnproceed" class="btn btn-sm btnconinsideBtn  pull-right btnprocced">Proceed</button>
</div>
                                ...
                                <div class="bussinesscontent ">
                                    ...
                                    <div class=" col-md-12 col-sm-12 col-xs-12  ">
                                        ...
                                        <div class="addressScroll scrollbar" id="AddressDiv">
                                               <div class="col-md-12 col-sm-12 col-xs-12 addaddress pb-3 mt-0" >
                                     <div class="row">
